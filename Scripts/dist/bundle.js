...
var TransformOperationExecutor_1 = __webpack_require__(60);
...
exports.InitModelAction = "INIT_MODEL";
exports.FilterOutletsAction = "FILTER_OUTLETS";
...
var MetadataStorage_1 = __webpack_require__(65);
/**
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(25);
...
exports.default = FilterEntity;
var DefaultFilterEntity = function () { return new FilterEntity(); };
exports.DefaultFilterEntity = DefaultFilterEntity;
...
Object.defineProperty(exports, "__esModule", { value: true });
var WebAgent_1 = __webpack_require__(121);
var class_transformer_1 = __webpack_require__(62);
var OutletEntity_1 = __webpack_require__(117);
var ActionTypes = __webpack_require__(17);
function InitializeModel() {
    return function (dispatch) {
        var webAgent = new WebAgent_1.WebAgent();
        webAgent
            .Get("http://localhost:50434/api/initialData/49.226/28.448", function (responseJson) {
            var deseriallizedObject = class_transformer_1.plainToClass(OutletEntity_1.OutletEntity, responseJson);
            dispatch({ type: ActionTypes.InitModelAction, payload: { Outlets: deseriallizedObject, FilterString: "" } });
        });
    };
}
exports.default = InitializeModel;
...
var react_router_dom_1 = __webpack_require__(99);
...
var redux_thunk_1 = __webpack_require__(113);
var ReducersBootstraper_1 = __webpack_require__(120);
var InitialState_1 = __webpack_require__(116);
var JunkStore = redux_1.applyMiddleware(redux_thunk_1.default)(redux_1.createStore)(ReducersBootstraper_1.default, InitialState_1.default());
exports.default = JunkStore;
...
var ClassTransformer_1 = __webpack_require__(9);
var storage_1 = __webpack_require__(24);
var TypeMetadata_1 = __webpack_require__(67);
var ExposeMetadata_1 = __webpack_require__(64);
var ExcludeMetadata_1 = __webpack_require__(63);
var TransformMetadata_1 = __webpack_require__(66);
/**
...
var ClassTransformer_1 = __webpack_require__(9);
var ClassTransformer_2 = __webpack_require__(9);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(86);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createHashHistory__ = __webpack_require__(103);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BrowserRouter__ = __webpack_require__(89);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createMemoryHistory__ = __webpack_require__(104);
...
Object.defineProperty(exports, "__esModule", { value: true });
var FilterEntity_1 = __webpack_require__(36);
function default_1() {
    return { Outlets: new Array(), Filter: FilterEntity_1.DefaultFilterEntity() };
}
...
var OutletEntity = (function (_super) {
    __extends(OutletEntity, _super);
    function OutletEntity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return OutletEntity;
}(BaseEntity_1.BaseEntity));
exports.OutletEntity = OutletEntity;
...
function FilterReducer(state, action) {
    if (state === void 0) { state = FilterEntity_1.DefaultFilterEntity(); }
    switch (action.type) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(18);
var OutletsReducer_1 = __webpack_require__(119);
var FilterReducer_1 = __webpack_require__(118);
exports.default = redux_1.combineReducers({ Outlets: OutletsReducer_1.default, Filter: FilterReducer_1.default });
...
var WebAgent = (function () {
    function WebAgent() {
    }
    WebAgent.prototype.Get = function (url, successCallback) {
...
var InitModel_1 = __webpack_require__(38);
var Store_1 = __webpack_require__(40);
var Routes_1 = __webpack_require__(39);
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: Store_1.default }, Routes_1.default), document.getElementById("app"));
//temporary thing to have a better "feel" of asynchronous call
setTimeout(function () {
    Store_1.default.dispatch(InitModel_1.default());
}, 1000);
